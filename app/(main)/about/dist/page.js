...
var PortraitA_png_1 = require("~/assets/PortraitA.png");
...
exports.metadata = {
    title: 'About',
    description: 'I’m XuFei. I live in Hangzhou City, where I design the future.'
};
function About() {
                            ...
                            react_1["default"].createElement("div", { className: "grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12" },
                                react_1["default"].createElement("div", { className: "lg:pl-20" },
                                    react_1["default"].createElement("div", { className: "max-w-xs px-2.5 lg:max-w-none" },
                                        react_1["default"].createElement(image_1["default"], { src: PortraitA_png_1["default"], alt: "", sizes: "(min-width: 1024px) 32rem, 20rem", className: "aspect-square rotate-3 rounded-2xl bg-zinc-100 object-cover dark:bg-zinc-800" })),
                                    ...
                                    react_1["default"].createElement("aside", { className: "space-y-10 lg:sticky lg:top-8 lg:h-fit lg:pl-16 xl:pl-20" },
                                        react_1["default"].createElement("div", { className: "flex flex-col gap-6 pt-6" },
                                            react_1["default"].createElement("h2", { className: "flex items-center text-sm font-semibold text-zinc-900 dark:text-zinc-100" },
                                                react_1["default"].createElement(assets_1.SunIcon, { className: "h-5 w-5 flex-none" }),
                                ...
                                react_1["default"].createElement("div", { className: "lg:order-first lg:row-span-2" },
                                    react_1["default"].createElement("h1", { className: "text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100" }, infoConfig_1.aboutMeHeadline),
