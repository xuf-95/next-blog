            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, (react_1["default"].createElement(Container_1.Container, { className: "mt-16 sm:mt-32" },
                            ...
                            react_1["default"].createElement("section", { id: "skills" },
                                react_1["default"].createElement("div", { className: "flex min-h-0 flex-col gap-y-3" },
                                    react_1["default"].createElement(blur_fade_1["default"], { delay: BLUR_FADE_DELAY * 9 },
                                        react_1["default"].createElement("h2", { className: "text-xl font-bold" }, "Skills")),
                                    react_1["default"].createElement("div", { className: "flex flex-wrap gap-2" }, resume_1.DATA.skills.map(function (skill, id) { return (react_1["default"].createElement(blur_fade_1["default"], { key: skill, delay: BLUR_FADE_DELAY * 10 + id * 0.05 },
                                        react_1["default"].createElement(badge_1.Badge, { className: "bg-white text-gray-800 shadow-sm border border-gray-200" // 新增样式
                                         }, skill))); })))),
                            react_1["default"].createElement("div", { className: "mx-auto flex flex-col max-w-xl gap-6 lg:max-w-none my-4 border-t border-zinc-100 py-8 dark:border-zinc-700/40" },
                                react_1["default"].createElement("section", { id: "work" },
                                    react_1["default"].createElement("div", { className: "flex min-h-0 flex-col gap-y-3" },
                                        react_1["default"].createElement(blur_fade_1["default"], { delay: BLUR_FADE_DELAY * 5 },
                                            react_1["default"].createElement("h2", { className: "text-xl font-bold" }, "Work Experience")),
                                        resume_1.DATA.work.map(function (work, id) {
                                            var _a;
                                            return (react_1["default"].createElement(blur_fade_1["default"], { key: work.company, delay: BLUR_FADE_DELAY * 6 + id * 0.05 },
                                                react_1["default"].createElement(resume_card_1.ResumeCard, { key: work.company, logoUrl: work.logoUrl, altText: work.company, title: work.company, subtitle: work.title, href: work.href, badges: work.badges, period: work.start + " - " + ((_a = work.end) !== null && _a !== void 0 ? _a : "Present"), description: work.description })));
                                        }))))))];
            }
        });
    });
